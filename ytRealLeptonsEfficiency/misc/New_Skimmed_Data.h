...
// Tue Dec 13 04:28:34 2016 by ROOT version 6.04/16
// from TTree AnaNtup/AnaNtup
// found on file: data_probes_all_periods.root
//////////////////////////////////////////////////////////

#ifndef New_Skimmed_Data_h
#define New_Skimmed_Data_h
...
class New_Skimmed_Data : public TSelector {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   New_Skimmed_Data(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~New_Skimmed_Data() { }
   ...
   ClassDef(New_Skimmed_Data,0);
};

#endif

#ifdef New_Skimmed_Data_cxx
void New_Skimmed_Data::Init(TTree *tree)
{
...
Bool_t New_Skimmed_Data::Notify()
{
...
#endif // #ifdef New_Skimmed_Data_cxx
