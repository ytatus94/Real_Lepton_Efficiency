...
h_data_baseline_OSee_mll.SetMarkerColor(0)
...
h_data_baseline_OSmumu_mll.SetMarkerColor(0)
...
h_data_signal_OSee_mll.SetMarkerColor(0)
...
h_data_signal_OSmumu_mll.SetMarkerColor(0)
