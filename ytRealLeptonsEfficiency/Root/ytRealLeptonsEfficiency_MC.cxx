...
void ytRealLeptonsEfficiency_MC :: loop_over_electrons()
{
    for (int n_el = 0; n_el < NEl; n_el++) {
        ...
        if (!truth_match) {
            ...
            h_bkg_template_fail_truth_pt_eta_mll->Fill(El_pT->at(n_el) / 1000., El_eta->at(n_el), El_ZTandP_mll->at(n_el) / 1000., normalization * baseline_weight);
        }
        if (!El_isMediumLH->at(n_el)) { // Background template requires the electron object fails the MediumLLH
            ...
            h_bkg_template_fail_id_only_pt_eta_mll->Fill(El_pT->at(n_el) / 1000., El_eta->at(n_el), El_ZTandP_mll->at(n_el) / 1000., normalization * baseline_weight);
            ...
            if (calo_isolation > 0.10) {
                ...
                h_bkg_template_fail_id_and_CaloIso_pt_eta_mll->Fill(El_pT->at(n_el) / 1000., El_eta->at(n_el), El_ZTandP_mll->at(n_el) / 1000., normalization * baseline_weight);
            }
