...
void ytRelative_difference_of_efficiency(float pt_low = 10., float pt_up = 200., bool rebin = true, bool eta_less_than_two = false)
{
	...
	TH1F *h_baseline_dRjet_rebinned_Zee = (TH1F *)h_baseline_dRjet_Zee->Rebin(6, "h_baseline_dRjet_rebinned_Zee", xbins_rebinned);
	TH1F *h_baseline_dRjet_rebinned_ttbar_elec = (TH1F *)h_baseline_dRjet_ttbar_elec->Rebin(6, "h_baseline_dRjet_rebinned_ttbar_elec", xbins_rebinned);
	TH1F *h_baseline_dRjet_rebinned_GG_ttn1_elec = (TH1F *)h_baseline_dRjet_GG_ttn1_elec->Rebin(6, "h_baseline_dRjet_rebinned_GG_ttn1_elec", xbins_rebinned);

	TH1F *h_signal_dRjet_rebinned_Zee = (TH1F *)h_signal_dRjet_Zee->Rebin(6, "h_signal_dRjet_rebinned_Zee", xbins_rebinned);
	TH1F *h_signal_dRjet_rebinned_ttbar_elec = (TH1F *)h_signal_dRjet_ttbar_elec->Rebin(6, "h_signal_dRjet_rebinned_ttbar_elec", xbins_rebinned);
	TH1F *h_signal_dRjet_rebinned_GG_ttn1_elec = (TH1F *)h_signal_dRjet_GG_ttn1_elec->Rebin(6, "h_signal_dRjet_rebinned_GG_ttn1_elec", xbins_rebinned);

	TH1F *h_baseline_dRjet_rebinned_Zmumu = (TH1F *)h_baseline_dRjet_Zmumu->Rebin(6, "h_baseline_dRjet_rebinned_Zmumu", xbins_rebinned);
	TH1F *h_baseline_dRjet_rebinned_ttbar_muon = (TH1F *)h_baseline_dRjet_ttbar_muon->Rebin(6, "h_baseline_dRjet_rebinned_ttbar_muon", xbins_rebinned);
	TH1F *h_baseline_dRjet_rebinned_GG_ttn1_muon = (TH1F *)h_baseline_dRjet_GG_ttn1_muon->Rebin(6, "h_baseline_dRjet_rebinned_GG_ttn1_muon", xbins_rebinned);

	TH1F *h_signal_dRjet_rebinned_Zmumu = (TH1F *)h_signal_dRjet_Zmumu->Rebin(6, "h_signal_dRjet_rebinned_Zmumu", xbins_rebinned);
	TH1F *h_signal_dRjet_rebinned_ttbar_muon = (TH1F *)h_signal_dRjet_ttbar_muon->Rebin(6, "h_signal_dRjet_rebinned_ttbar_muon", xbins_rebinned);
	TH1F *h_signal_dRjet_rebinned_GG_ttn1_muon = (TH1F *)h_signal_dRjet_GG_ttn1_muon->Rebin(6, "h_signal_dRjet_rebinned_GG_ttn1_muon", xbins_rebinned);
	...
	if (rebin) {
		h_average_eff_rebinned_Zee = (TH1F *)h_average_eff_Zee->Rebin(6, "h_average_eff_rebinned_Zee", xbins_rebinned);
		h_average_eff_rebinned_Zmumu = (TH1F *)h_average_eff_Zmumu->Rebin(6, "h_average_eff_rebinned_Zmumu", xbins_rebinned);
	}
