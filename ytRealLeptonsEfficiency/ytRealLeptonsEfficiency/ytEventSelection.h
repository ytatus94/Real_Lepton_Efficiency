#ifndef ytRealLeptonsEfficiency_ytEventSelection_H
#define ytRealLeptonsEfficiency_ytEventSelection_H
...
#include "ytRealLeptonsEfficiency/Leptons.h"
...
*/
    ...
    void set_process(TString s) { process = s; }
